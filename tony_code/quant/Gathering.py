...
def get_stock(code, startdate, enddate=None, dtype='D'):
...
리턴: 주봉 데이터프레임    '''
def get_week_stock(code, startdate, enddate):
...
# def backtest_for_week(code, signal_df):    
